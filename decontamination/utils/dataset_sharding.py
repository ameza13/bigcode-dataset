...
def shard_dataset(ds, shard_size, output_dir, num_proc, name=""):
    ...
    filenames = (f"{output_dir}/{name}-train-{index:05d}-of-{num_shards:05d}.jsonl" for index in range(num_shards))
